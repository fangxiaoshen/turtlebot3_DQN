...
class PPO(object):
    ...
    def __init__(self):
        ...
        if self.load_models:
            load_model1 = torch.load("/home/ffd/QDN/model/210actor.pkl")
    ...
    def save_param(self,e):
        ...
        torch.save(state,"/home/ffd/QDN/model/"+str(e)+"a.pt")
    ...
    for e in range(10000):
        ...
        for t in range(episode_step):
            ...
            if done :
                ...
                h,m =divmod(m,60)
                agent.update(e)
                rospy.loginfo('Ep: %d score: %.2f memory: %d episode_step: %.2f time: %d:%02d:%02d' , e ,episode_reward_sum, agent.counter,episode_step, h, m, s)
                break
